...
{
	std::string modelPath = "C:\\Program Files (x86)\\KolosalAI\\models\\qwen2.5-0.5b\\int4";
	...
	try
	{
		...
		CompletionParameters chatParams;
		chatParams.prompt = "Halo adalah";
		...
		int jobId = engine->submitCompletionsJob(chatParams);
